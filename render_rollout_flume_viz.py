...
class Render():
    ...
    def __init__(self, input_dir, input_name):
        ...
        print(np.max(trajectory["ground_truth_rollout"][400, :, 1]))
    ...
    def color_mask(self):
        ...
        #print(max_wave_heights)
       
        wave_particles_ind = np.where(y_values > max_base_y)
        #print(wave_particles_ind[0])
        # Change Material id values 
        #print(self.particle_type[wave_particles_ind[0]])
        #print(self.particle_type[wave_particles_ind[1]])
        self.particle_type[wave_particles_ind[0]] = 8
        self.particle_type[wave_particles_ind[1]] = 8
        #print(self.particle_type[wave_particles_ind[0]])
        #print(self.particle_type[wave_particles_ind[1]])
